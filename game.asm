...
# 1. Assign points to player on every successful prevention of crash and show total score on the end of game screen
# 2. Implemented different levels of difficulties (up to 7 levels), 
#    new type of obstacles and more obstacles in the higher difficulties.
# 3. Player will enter a new difficulty every 150 game loops, when level up, a screen will show
# 4. Implemented gazing collision, when collide with only one pixel, 40% of chance getting damage of half a heart
# 
# Link to video demonstration for final submission:
# - https://play.library.utoronto.ca/watch/8bee7e77677fedb31f92009b87342b8b (UofT only)
# - https://www.bilibili.com/video/BV1BL411E7PV (Open to access)
#
# Are you OK with us sharing the video with people outside course staff?
# - yes, and please share this project github link as well!
# - github: https://github.com/ddxxdd-code/CSC258_project_2021_summer
#
# Any additional information that the TA needs to know:
# - This is an individual project
# - I used syscalls provided by MARS to play sound via MIDI output to give the game more fun.
...
.data
	...
	obstacleRow:	.word	0:16
	obstacleColumn:	.word	0:16
...
main:
	...
	beq	$s4, 200, levelUpPoint		# if round == 200, level up
	jal	getInput
	jal	updateObstacle
	j 	gameLoop
...
drawStartScreen:				# draw the start screen
	...
	li	$t2, 0xaeaeae		# $t2 stores the dark grey color code
