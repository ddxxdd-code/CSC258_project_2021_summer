...
collisionAnimation:
	startAnimation:
	li	$v0, 4
	la	$a0, debug_collision_detect
	syscall
	
	beqz	$s3, endAnimation		# no damage, no animation
	li	$v0, 4
	la	$a0, debug_collision_detected
	syscall
